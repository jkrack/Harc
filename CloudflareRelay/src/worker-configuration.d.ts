/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 897da3b333131a9e2df3abc6b5ba2aac)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	SESSION_RATE_LIMITER: RateLimit;
	HOST_RENDEZVOUS: DurableObjectNamespace<import("./index").HostRendezvous>;
	RELAY_SESSION: DurableObjectNamespace<import("./index").RelaySession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "HostRendezvous" | "RelaySession";
	}
