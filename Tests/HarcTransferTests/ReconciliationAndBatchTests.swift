...
struct ReconciliationAndBatchTests {
    ...
    func reconciliationValidation() throws {
        ...
        let value = try UploadReconciliation(
            ...
            generation: .initial,
            firstBeganAt: TransferFixtures.baseDate,
            generationBeganAt: TransferFixtures.baseDate,
        ...
        #expect(throws: TransferValidationError.self) {
            try UploadReconciliation(
                ...
                uploadProfileSHA256: TransferFixtures.profile().profileSHA256,
                generation: .initial,
                firstBeganAt: TransferFixtures.baseDate.addingTimeInterval(-60),
                generationBeganAt: TransferFixtures.baseDate.addingTimeInterval(-60),
