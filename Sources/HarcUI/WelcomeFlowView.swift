...
public final class WelcomeFlowModel: ObservableObject {
    ...
    public static let defaultSteps: [WelcomeFlowStep] = [
        ...
        WelcomeFlowStep(
            ...
            body: "Speech-to-text, diarization, and summaries run on your Apple silicon. Harc records to disk while it captures, then processes locally in rolling chunks. Your notes live as plain Markdown on disk, and a built-in MCP connector lets AI agents you run — Claude Desktop, Claude Code — search and annotate them.",
            primaryPoint: "No cloud STT, no external telemetry, no account requirement.",
            secondaryPoint: "Standalone content stays on this Mac. If you later adopt a Host, Harc synchronizes only to that authenticated computer unless you explicitly export elsewhere.",
