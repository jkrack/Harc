...
enum SettingsSearchIndex {
    ...
    static let entries: [SettingsSearchEntry] = [
        ...
        .init(pane: .recording, label: "Quick Capture",
              keywords: ["quick", "sheet", "name", "title", "start", "island", "pill"]),
        .init(pane: .recording, label: "Capture system audio",
              keywords: ["system audio", "screen", "call", "other side", "mic only",
                         "screencapturekit", "speakers"]),
